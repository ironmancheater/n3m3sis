...
local m_alpha = 0
local username = _G.obex_name == nil and 'nil' or _G.obex_name
local build = _G.obex_build == nil and 'nil' or _G.obex_build
local upper_case = username:upper()
local lower_case = username:lower()

print("---------------------------------")
print("Welcome to voidness " .. username)
print("You're currently using: " .. build)
print("Last updated: 29.07.2022 23:15")
print("---------------------------------")

local lua_enable = ui.new_checkbox("AA", "Anti-aimbot angles", "enable \aA981B5FFvoidness\aFFFFFFC9.technology")
...
aa_init[0] = {
	...
	heylabel = ui.new_label("AA", "Anti-aimbot angles", "            Welcome to \aA981B5FFvoidness"),
	heylabel2 = ui.new_label("AA", "Anti-aimbot angles", "           \aA981B5FFLast update : \aFFFFFFC929.07.22"),
	heyl2 = ui.new_label("AA", "Anti-aimbot angles", "         \a494949FF------------------------------"),
	lua_select = ui.new_combobox("AA", "Anti-aimbot angles", "lua \aA981B5FFsection", "anti-aimbot", "visuals", "miscellaneous"),
	heyl3 = ui.new_label("AA", "Anti-aimbot angles", "                       \a494949FF------"),
	presets = ui.new_combobox("AA", "Anti-aimbot angles", "\aA981B5FF⎾aa⏌ \aFFFFFFC9- presets", "jitter", "static", "experimental", "matchmaking"),
	aalabelextra = ui.new_label("AA", "Anti-aimbot angles", "                       \a494949FF------"),
	aa_abf = ui.new_checkbox("AA", "Anti-aimbot angles","\aA981B5FF⎾aa⏌ \aFFFFFFC9- anti-\aA981B5FFbruteforce"),
	aa_stc_tillhit = ui.new_checkbox("AA", "Anti-aimbot angles","static until hittable"),
	legit_e_key = ui.new_checkbox("AA", "Anti-aimbot angles", "\aA981B5FF⎾aa⏌ \aFFFFFFC9- \aA981B5FFlegit \aFFFFFFC9anti-aimbot on \aA981B5FF'e'"),
	keyaalabel = ui.new_label("AA", "Anti-aimbot angles", "                       \a494949FF------"),
	fs = ui.new_hotkey("AA", "Anti-aimbot angles", "\aA981B5FF⎾aa⏌ \aFFFFFFC9- freestanding"),
	manual_left = ui.new_hotkey("AA", "Anti-aimbot angles", "\aA981B5FF⎾aa⏌ \aFFFFFFC9- manual anti-aimbot - \aA981B5FFleft"),
	manual_right = ui.new_hotkey("AA", "Anti-aimbot angles", "\aA981B5FF⎾aa⏌ \aFFFFFFC9- manual anti-aimbot - \aA981B5FFright"),
	manual_forward = ui.new_hotkey("AA", "Anti-aimbot angles", "\aA981B5FF⎾aa⏌ \aFFFFFFC9- manual anti-aimbot - \aA981B5FFforward"),
	customaalabel = ui.new_label("AA", "Anti-aimbot angles", "                       \a494949FF------"),
	aa_builder = ui.new_checkbox("AA", "Anti-aimbot angles", "custom \aA981B5FFanti-aimbot \aFFFFFFC9builder"),
	player_state = ui.new_combobox("AA", "Anti-aimbot angles", "anti-aimbot \aA981B5FFstates", "standing", "moving", "slowwalking", "in-air", "ducking", "air-ducking"),
}

--#region "visuals indicators whatever"
local main_clr_l = ui.new_label("AA", "Anti-aimbot angles", "\aA981B5FF⎾vis⏌ \aFFFFFFC9- \aA981B5FFmain \aFFFFFFC9color")
local main_clr = ui.new_color_picker("AA", "Anti-aimbot angles", "main color", 219, 181, 231, 255)
local vislabel = ui.new_label("AA", "Anti-aimbot angles", "                       \a494949FF------")
local crosshair_inds = ui.new_checkbox("AA", "Anti-aimbot angles", "\aA981B5FF⎾vis⏌ \aFFFFFFC9- crosshair \aA981B5FFindicators")
local inds_selct = ui.new_combobox("AA", "Anti-aimbot angles", "\aA981B5FFindicators \aFFFFFFC9style", { "ephemeral", "ephemeral right", "acatel" })
local manaa_inds = ui.new_checkbox("AA", "Anti-aimbot angles", "\aA981B5FF⎾vis⏌ \aFFFFFFC9- \aA981B5FFcrosshair \aFFFFFFC9anti-aimbot \aA981B5FFarrows")
local arrw_selct = ui.new_combobox("AA", "Anti-aimbot angles", "arrow \aA981B5FFstyle", { "default", "manual", "desync" })
local scopelabel = ui.new_label("AA", "Anti-aimbot angles", "                       \a494949FF------")
local master_switch = ui.new_checkbox("AA", "Anti-aimbot angles", '\aA981B5FF⎾vis⏌ \aFFFFFFC9- scope \aA981B5FFcustomization')
local color_picker = ui.new_color_picker("AA", "Anti-aimbot angles", '\n scope_lines_color_picker', 255, 255, 255, 255)
local overlay_position = ui.new_slider("AA", "Anti-aimbot angles", 'initial \aA981B5FFposition', 0, 500, 0)
local overlay_offset = ui.new_slider("AA", "Anti-aimbot angles", 'lines \aA981B5FFoffset', 0, 500, 40)
local fade_time = ui.new_slider("AA", "Anti-aimbot angles", 'fade \aA981B5FFanimation \aFFFFFFC9speed', 3, 20, 12, true, 'fr', 1, { [3] = 'Off' })
local othlabel = ui.new_label("AA", "Anti-aimbot angles", "                       \a494949FF------")
local enable_def = ui.new_checkbox("AA", "Anti-aimbot angles", "\aA981B5FF⎾vis⏌ \aFFFFFFC9- defensive dt \aA981B5FFwarning")
local trashtalk = ui.new_checkbox("AA", "Anti-aimbot angles", "\aA981B5FF⎾vis⏌ \aFFFFFFC9- trash\aA981B5FFtalk")
local anti_knife = ui.new_checkbox("AA", "Anti-aimbot angles", "\aA981B5FF⎾misc⏌ \aFFFFFFC9- \aA981B5FFanti \aFFFFFFC9knife \aA981B5FFbackstab")
local knife_distance = ui.new_slider("AA", "Anti-aimbot angles", "activation \aA981B5FFdistance",0,300,150,true,"''")
local vislabelleg = ui.new_label("AA", "Anti-aimbot angles", "                       \a494949FF------")
local legszz = ui.new_multiselect("AA", "Anti-aimbot angles", "\aA981B5FF⎾misc⏌ \aFFFFFFC9- animation \aA981B5FFbreakers", "static legs in-air", "leg breaker")
local fllabel = ui.new_label("AA", "Anti-aimbot angles", "                       \a494949FF------")
local expflclick = ui.new_checkbox("AA", "Anti-aimbot angles", "\aA981B5FF⎾misc⏌ \aFFFFFFC9- \aA981B5FF16-60 \aFFFFFFC9ticks fakelag")
local expfl = ui.new_combobox("AA", "Anti-aimbot angles", "value \aA981B5FFselection", { "16", "25", "40", "60"})
local erlabel = ui.new_label("AA", "Anti-aimbot angles", "                       \a494949FF------")
local resolabel = ui.new_label("AA", "Anti-aimbot angles", "\aFF3232B3⚠️ \aFFFFFFC9Keep in mind that resolver is in beta!")
local resolvera = ui.new_checkbox("AA", "Anti-aimbot angles", "\aA981B5FF⎾misc⏌ \aFFFFFFC9- resolver \aA981B5FFhelper \aFFFFFFC9(\aEBE534FFw.i.p\aFFFFFFC9)")

for i=1, 7 do
	aa_init[i] = {
		aabuilderenable =  ui.new_checkbox("AA", "Anti-aimbot angles", "enable | ".. ""..var.p_states[i].." \aA981B5FFanti-aimbot \aFFFFFFC9state"),
		enablelabelu = ui.new_label("AA", "Anti-aimbot angles", "                       \a494949FF------"),
		aayawleft = ui.new_slider("AA", "Anti-aimbot angles", ""..var.p_states[i].." | Yaw \aFFFFFFC9[\aA981B5FFLeft\aFFFFFFC9]\n", -180, 180, 0),
		aayawright = ui.new_slider("AA", "Anti-aimbot angles",""..var.p_states[i].." | Yaw \aFFFFFFC9[\aA981B5FFRight\aFFFFFFC9]\n", -180, 180, 0),
		enablelabelu1 = ui.new_label("AA", "Anti-aimbot angles", "                       \a494949FF------"),
		aayawjitter = ui.new_combobox("AA", "Anti-aimbot angles",""..var.p_states[i].." | Yaw \aFFFFFFC9[\aA981B5FFJitter\aFFFFFFC9]\n" .. var.p_states[i], { "off", "offset", "center", "random" }),
		...
		aayawbody = ui.new_combobox("AA", "Anti-aimbot angles",""..var.p_states[i].." | Yaw \aFFFFFFC9[\aA981B5FFBody\aFFFFFFC9]\n" .. var.p_states[i], { "off", "opposite", "jitter", "static"}),
		aayawstatic = ui.new_slider("AA", "Anti-aimbot angles","\n", -180, 180, 0),
		enablelabelu3 = ui.new_label("AA", "Anti-aimbot angles", "                       \a494949FF------"),
		aafakeside = ui.new_combobox("AA", "Anti-aimbot angles",""..var.p_states[i].." | Yaw \aFFFFFFC9[\aA981B5FFFake Limit Side\aFFFFFFC9]\n" .. var.p_states[i], { "left", "right" }),
		aayawfakelimit = ui.new_slider("AA", "Anti-aimbot angles","\n", 0, 60, 60,true,"°"),
		aayawfakelimitright = ui.new_slider("AA", "Anti-aimbot angles","\n", 0, 60, 60,true,"°"),
		enablelabelu4 = ui.new_label("AA", "Anti-aimbot angles", "                       \a494949FF------"),
		aayawroll = ui.new_slider("AA", "Anti-aimbot angles",""..var.p_states[i].." | Yaw \aFFFFFFC9[\aA981B5FFRoll\aFFFFFFC9]\n".. var.p_states[i], -50, 50, 0, true, "°"),
		enablelabelu5 = ui.new_label("AA", "Anti-aimbot angles", "                       \a494949FF------"),
		aayawantibrute =  ui.new_checkbox("AA", "Anti-aimbot angles", ""..var.p_states[i].." | Yaw \aFFFFFFC9[\aA981B5FFAnti-Bruteforce\aFFFFFFC9]"),
		aayawavoidoverlap =  ui.new_checkbox("AA", "Anti-aimbot angles", ""..var.p_states[i].." | Yaw \aFFFFFFC9[\aA981B5FFAvoid Overlap\aFFFFFFC9]"),
...
local function set_lua_menu()
	...
	if is_misc and is_enabled then
		...
		ui.set_visible(resolvera, false)
	...
	if ui.get(resolvera) and is_misc and is_enabled then
		ui.set_visible(resolabel, true)
	else
		ui.set_visible(resolabel, false)
	end
	...
	if ui.get(aa_init[0].aa_builder) and is_enabled then
		for i=1, 7 do
			...
			if ui.get(aa_init[i].aabuilderenable) then
				...
				ui.set_visible(aa_init[i].aayawstatic, var.active_i == i and ui.get(aa_init[i].aayawbody) ~= "off" and ui.get(aa_init[i].aayawbody) ~= "opposite")

				ui.set_visible(aa_init[i].aafakeside,var.active_i == i and is_aa)
				ui.set_visible(aa_init[i].aayawfakelimit,var.active_i == i and ui.get(aa_init[i].aafakeside) == "left" and is_aa)
				ui.set_visible(aa_init[i].aayawfakelimitright,var.active_i == i and ui.get(aa_init[i].aafakeside) == "right" and is_aa)
				...
				ui.set_visible(aa_init[i].aayawfakelimit,false)
				ui.set_visible(aa_init[i].aayawfakelimitright,false)
...
client.set_event_callback("pre_render", function ()
	...
	local legs_types = {[1] = "Never slide", [2] = "Always slide" , [3] = "Never slide", [4] = "Off"}
...
client.set_event_callback("setup_command", function(c)
	...
	if aa.ignore == false then
		...
		if ui.get(aa_init[var.p_state].aabuilderenable) and ui.get(aa_init[0].aa_builder) then
			...
			if bodyyaw > 0 then
				ui.set(fake_yaw, ui.get(aa_init[var.p_state].aayawfakelimitright))
			elseif bodyyaw < 0 then
				ui.set(fake_yaw,ui.get(aa_init[var.p_state].aayawfakelimit))
			end
		else
			ui.set(ref.pitch, "Minimal")
			...
			elseif ui.get(aa_init[0].presets) == "static" then
				if var.p_state == 1 then
					ui.set(ref.yawjitter[1], "Off")
					ui.set(ref.yawjitter[2], 0)
			...
			elseif ui.get(aa_init[0].presets) == "experimental" then
				...
				elseif var.p_state == 4 then
					ui.set(ref.yawjitter[1], "Center")
					ui.set(ref.yawjitter[2], 6)
					ui.set(byaw, "Jitter")
					ui.set(ref.bodyyaw[2], 0)
					if c.chokedcommands ~= 0 then
					else
						ui.set(ref.yaw[2],(side == 1 and -37 or 37))
					end
					ui.set(ref.fakeyawlimit, 60)
				elseif var.p_state == 5 then
					ui.set(ref.yawjitter[1], "Center")
			...
			elseif ui.get(aa_init[0].presets) == "matchmaking" then
				if var.p_state == 1 then
					ui.set(ref.yawjitter[1], "Center")
					ui.set(ref.yawjitter[2], 28)
					ui.set(ref.bodyyaw[1], "jitter")
...
local function draw()
	...
	if ui.get(inds_selct) == "ephemeral" and ui.get(crosshair_inds) then
		...
		renderer.text(x / 2+7 + testx, y / 2 + 25, 255,255,255, alpha, "-", 0, 'BETA')
	...
	if ui.get(inds_selct) == "ephemeral right" and ui.get(crosshair_inds) then
		...
		renderer.text(x / 2 + 48, y / 2 + 27, 255,255,255, alpha, "-", 0, 'BETA')
...
local export_btn = ui.new_button("AA", "Other", "export \aA981B5FFvoidness \aFFFFFFC9configuration", export_config)
...
local import_btn = ui.new_button("AA", "Other", "import \aA981B5FFvoidness \aFFFFFFC9configuration", import_config)
...
local function on_net_update_end (c)
    for _, player in ipairs(entity.get_players(true)) do
        ...
        if delta < 0 then
            ...
            print(string.format("Registered %s's exploit as defensive due to unusual tick spike, t= %s", player:get_player_name(), delta))
...
ui.set_callback(enable_def, function()
    ...
    if not esp_flag_set then
        client.register_esp_flag("DEFENSIVE", 219, 181, 231, handle_esp_flag)
        esp_flag_set = true    
    end
end)
...
if ui.get(resolvera) == true then
    plist_set(player, "Correction active", true)
    plist_set(player, "Force body yaw", true)
    plist_set(player, "Force body yaw value", math.random(10,20))
  else
...
local signature_ginput = base64.decode("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=")
